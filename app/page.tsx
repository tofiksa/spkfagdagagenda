...
export default function IndexPage() {
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell colSpan={4} className="text-center bg-muted">Kaffe og frukt</TableCell>
    </TableRow>
  </TableBody>
  <TableBody>
    <TableRow>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell colSpan={4} className="text-center bg-muted">Lunsj</TableCell>
    </TableRow>
  </TableBody>
  <TableBody>
    <TableRow>
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell colSpan={4} className="text-center bg-muted">Gruppeaktivitet i expoområdet</TableCell>
    </TableRow>
  </TableBody>
</Table>
